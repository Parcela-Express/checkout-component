  ...
  describe('PosApi', function() {
    describe('listPos', function() {
      it('should call listPos successfully', function(done) {
        //uncomment below and update the code to test listPos
        //instance.listPos(function(error) {
    ...
    describe('updateBackofficePos', function() {
      it('should call updateBackofficePos successfully', function(done) {
        //uncomment below and update the code to test updateBackofficePos
        //instance.updateBackofficePos(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
