...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.Responsible();
  });
  ...
  describe('Responsible', function() {
    it('should create an instance of Responsible', function() {
      // uncomment below and update the code to test Responsible
      //var instane = new ParcelaExpressApi.Responsible();
      //expect(instance).to.be.a(ParcelaExpressApi.Responsible);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.Responsible();
