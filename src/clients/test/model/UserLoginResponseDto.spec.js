...
(function(root, factory) {
  ...
  describe('UserLoginResponseDto', function() {
    it('should create an instance of UserLoginResponseDto', function() {
      // uncomment below and update the code to test UserLoginResponseDto
      //var instane = new ParcelaExpressApi.UserLoginResponseDto();
      //expect(instance).to.be.a(ParcelaExpressApi.UserLoginResponseDto);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.UserLoginResponseDto();
