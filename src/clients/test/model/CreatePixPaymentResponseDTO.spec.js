...
(function(root, factory) {
  ...
  describe('CreatePixPaymentResponseDTO', function() {
    it('should create an instance of CreatePixPaymentResponseDTO', function() {
      // uncomment below and update the code to test CreatePixPaymentResponseDTO
      //var instane = new ParcelaExpressApi.CreatePixPaymentResponseDTO();
    ...
    it('should have the property resultCode (base name: "resultCode")', function() {
      ...
      //var instance = new ParcelaExpressApi.CreatePixPaymentResponseDTO();
