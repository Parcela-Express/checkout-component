...
class CreateBilletDto {
    ...
    constructor(value, social_security_number, shopper_statement, description, delivery_date, shopper) { 
        ...
        CreateBilletDto.initialize(this, value, social_security_number, shopper_statement, description, delivery_date, shopper);
    }
 ...
 */
CreateBilletDto.prototype['social_security_number'] = undefined;

/**
 * Descrição do boleto
 * @member {String} shopper_statement
 */
CreateBilletDto.prototype['shopper_statement'] = undefined;
 ...
 */
CreateBilletDto.prototype['delivery_date'] = undefined;
 ...
 */
CreateBilletDto.prototype['has_split_rules'] = undefined;

/**
 * Divisão de pagamento
 * @member {Array.<module:model/CreateSplitRulesDto>} split_rules
 */
CreateBilletDto.prototype['split_rules'] = undefined;

/**
 * Há confirmação de pagamento
 * @member {Boolean} confirmation_required
 */
CreateBilletDto.prototype['confirmation_required'] = undefined;

/**
 * Há link de pagamento
 * @member {Boolean} with_payment_link
 */
CreateBilletDto.prototype['with_payment_link'] = undefined;

/**
 * Número do protocolo
 * @member {String} protocol
 */
CreateBilletDto.prototype['protocol'] = undefined;

/**
 * Instruções para o boleto(caso vazio será usado o campo description)
 * @member {String} instructions
 */
CreateBilletDto.prototype['instructions'] = undefined;
...
export default CreateBilletDto;
