...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.Permission();
  });
  ...
  describe('Permission', function() {
    it('should create an instance of Permission', function() {
      ...
      //var instane = new ParcelaExpressApi.Permission();
      //expect(instance).to.be.a(ParcelaExpressApi.Permission);
    });
    ...
    it('should have the property actions (base name: "actions")', function() {
      ...
      //var instance = new ParcelaExpressApi.Permission();
