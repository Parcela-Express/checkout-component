...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.Acquirer();
  });
  ...
  describe('Acquirer', function() {
    it('should create an instance of Acquirer', function() {
      ...
      //var instane = new ParcelaExpressApi.Acquirer();
      //expect(instance).to.be.a(ParcelaExpressApi.Acquirer);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.Acquirer();
