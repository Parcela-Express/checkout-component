...
(function(root, factory) {
  ...
  describe('GetSellerPosDto', function() {
    it('should create an instance of GetSellerPosDto', function() {
      // uncomment below and update the code to test GetSellerPosDto
      //var instane = new ParcelaExpressApi.GetSellerPosDto();
      //expect(instance).to.be.a(ParcelaExpressApi.GetSellerPosDto);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.GetSellerPosDto();
      //expect(instance).to.be();
    });

    it('should have the property associated_at (base name: "associated_at")', function() {
      // uncomment below and update the code to test the property associated_at
      //var instance = new ParcelaExpressApi.GetSellerPosDto();
      //expect(instance).to.be();
    });
