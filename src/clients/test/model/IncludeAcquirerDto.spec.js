...
(function(root, factory) {
  ...
  describe('IncludeAcquirerDto', function() {
    it('should create an instance of IncludeAcquirerDto', function() {
      // uncomment below and update the code to test IncludeAcquirerDto
      //var instane = new ParcelaExpressApi.IncludeAcquirerDto();
    ...
    it('should have the property acquirer_id (base name: "acquirer_id")', function() {
      ...
      //var instance = new ParcelaExpressApi.IncludeAcquirerDto();
