...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.UpdateSellerThemeDto();
  });
  ...
  describe('UpdateSellerThemeDto', function() {
    it('should create an instance of UpdateSellerThemeDto', function() {
      // uncomment below and update the code to test UpdateSellerThemeDto
      //var instane = new ParcelaExpressApi.UpdateSellerThemeDto();
      //expect(instance).to.be.a(ParcelaExpressApi.UpdateSellerThemeDto);
    });
    ...
    it('should have the property primary_color (base name: "primary_color")', function() {
      ...
      //var instance = new ParcelaExpressApi.UpdateSellerThemeDto();
