...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.UpdateMerchantDto();
  });
  ...
  describe('UpdateMerchantDto', function() {
    it('should create an instance of UpdateMerchantDto', function() {
      // uncomment below and update the code to test UpdateMerchantDto
      //var instane = new ParcelaExpressApi.UpdateMerchantDto();
      //expect(instance).to.be.a(ParcelaExpressApi.UpdateMerchantDto);
    });
    ...
    it('should have the property document (base name: "document")', function() {
      ...
      //var instance = new ParcelaExpressApi.UpdateMerchantDto();
