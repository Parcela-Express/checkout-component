...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateDebitCustomerDTO', function() {
      beforeEach(function() {
        instance = new ParcelaExpressApi.CreateDebitCustomerDTO();
      });

      it('should create an instance of CreateDebitCustomerDTO', function() {
        // TODO: update the code to test CreateDebitCustomerDTO
        expect(instance).to.be.a(ParcelaExpressApi.CreateDebitCustomerDTO);
      });
