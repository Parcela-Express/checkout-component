...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.CreateExportProtocolListDto();
  });
  ...
  describe('CreateExportProtocolListDto', function() {
    it('should create an instance of CreateExportProtocolListDto', function() {
      // uncomment below and update the code to test CreateExportProtocolListDto
      //var instane = new ParcelaExpressApi.CreateExportProtocolListDto();
      //expect(instance).to.be.a(ParcelaExpressApi.CreateExportProtocolListDto);
    });
    ...
    it('should have the property seller_id (base name: "seller_id")', function() {
      ...
      //var instance = new ParcelaExpressApi.CreateExportProtocolListDto();
