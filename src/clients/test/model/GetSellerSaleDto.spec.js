...
(function(root, factory) {
  ...
  describe('GetSellerSaleDto', function() {
    it('should create an instance of GetSellerSaleDto', function() {
      // uncomment below and update the code to test GetSellerSaleDto
      //var instane = new ParcelaExpressApi.GetSellerSaleDto();
      //expect(instance).to.be.a(ParcelaExpressApi.GetSellerSaleDto);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.GetSellerSaleDto();
