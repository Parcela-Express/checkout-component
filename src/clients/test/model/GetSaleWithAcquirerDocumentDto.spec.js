...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.GetSaleWithAcquirerDocumentDto();
  });
  ...
  describe('GetSaleWithAcquirerDocumentDto', function() {
    it('should create an instance of GetSaleWithAcquirerDocumentDto', function() {
      // uncomment below and update the code to test GetSaleWithAcquirerDocumentDto
      //var instane = new ParcelaExpressApi.GetSaleWithAcquirerDocumentDto();
      //expect(instance).to.be.a(ParcelaExpressApi.GetSaleWithAcquirerDocumentDto);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.GetSaleWithAcquirerDocumentDto();
