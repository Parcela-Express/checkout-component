...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAccountingAccountDto', function() {
      beforeEach(function() {
        instance = new ParcelaExpressApi.GetAccountingAccountDto();
      });

      it('should create an instance of GetAccountingAccountDto', function() {
        // TODO: update the code to test GetAccountingAccountDto
        expect(instance).to.be.a(ParcelaExpressApi.GetAccountingAccountDto);
      });
