...
(function(root, factory) {
  ...
  describe('CancelPaymentResponseDTO', function() {
    it('should create an instance of CancelPaymentResponseDTO', function() {
      // uncomment below and update the code to test CancelPaymentResponseDTO
      //var instane = new ParcelaExpressApi.CancelPaymentResponseDTO();
    ...
    it('should have the property pspReference (base name: "pspReference")', function() {
      ...
      //var instance = new ParcelaExpressApi.CancelPaymentResponseDTO();
