...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.GetAddressDto();
  });
  ...
  describe('GetAddressDto', function() {
    it('should create an instance of GetAddressDto', function() {
      // uncomment below and update the code to test GetAddressDto
      //var instane = new ParcelaExpressApi.GetAddressDto();
      //expect(instance).to.be.a(ParcelaExpressApi.GetAddressDto);
    });
    ...
    it('should have the property complement (base name: "complement")', function() {
      ...
      //var instance = new ParcelaExpressApi.GetAddressDto();
