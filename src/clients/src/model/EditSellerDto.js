...
class EditSellerDto {
     ...
     * @param code {String} 
     * @param settlement_type {module:model/EditSellerDto.SettlementTypeEnum} 
     ...
     * @param billet_provider {module:model/EditSellerDto.BilletProviderEnum} 
     */
    constructor(name, description, document, code, settlement_type, address, bank_account, monthly_billing, status, type, merchant_id, sale_plan_id, billet_provider) { 
        
        EditSellerDto.initialize(this, name, description, document, code, settlement_type, address, bank_account, monthly_billing, status, type, merchant_id, sale_plan_id, billet_provider);
    }
     ...
     */
    static initialize(obj, name, description, document, code, settlement_type, address, bank_account, monthly_billing, status, type, merchant_id, sale_plan_id, billet_provider) { 
        obj['name'] = name;
 ...
 */
EditSellerDto.prototype['document_ofac'] = undefined;

/**
 * @member {Boolean} document_onu
 */
EditSellerDto.prototype['document_onu'] = undefined;

/**
 * @member {Boolean} document_rf
 */
EditSellerDto.prototype['document_rf'] = undefined;

/**
 * @member {String} state_registration
 */
EditSellerDto.prototype['state_registration'] = undefined;
 ...
 */
EditSellerDto.prototype['created_at'] = undefined;

/**
 * @member {module:model/EditSellerDto.SettlementTypeEnum} settlement_type
 */
EditSellerDto.prototype['settlement_type'] = undefined;
 ...
 */
EditSellerDto.prototype['bank_account'] = undefined;

/**
 * @member {Number} monthly_billing
 */
EditSellerDto.prototype['monthly_billing'] = undefined;
 ...
 */
EditSellerDto.prototype['is_split'] = undefined;
 ...
 */
EditSellerDto.prototype['secondary_phone'] = undefined;

/**
 * @member {String} tertiary_phone
 */
EditSellerDto.prototype['tertiary_phone'] = undefined;

/**
 * @member {Array.<String>} absorb_costs
 */
EditSellerDto.prototype['absorb_costs'] = undefined;
 ...
 */
EditSellerDto.prototype['merchant_id'] = undefined;

/**
 * @member {String} sale_plan_id
 */
EditSellerDto.prototype['sale_plan_id'] = undefined;

/**
 * @member {Boolean} pix_pos
 */
EditSellerDto.prototype['pix_pos'] = undefined;

/**
 * @member {module:model/EditSellerDto.BilletProviderEnum} billet_provider
 */
EditSellerDto.prototype['billet_provider'] = undefined;

/**
 * @member {Boolean} is_assignor
 */
EditSellerDto.prototype['is_assignor'] = undefined;

/**
 * @member {Array.<String>} no_payment_methods
 */
EditSellerDto.prototype['no_payment_methods'] = undefined;

/**
 * @member {Boolean} has_split_rules
 */
EditSellerDto.prototype['has_split_rules'] = undefined;

/**
 * @member {module:model/ProtocolCustomizations} protocol_customizations
 */
EditSellerDto.prototype['protocol_customizations'] = undefined;

/**
 * @member {module:model/EditSellerDto.PixProviderEnum} pix_provider
 */
EditSellerDto.prototype['pix_provider'] = undefined;

/**
 * @member {String} email
 */
EditSellerDto.prototype['email'] = undefined;

/**
 * @member {String} secondary_email
 */
EditSellerDto.prototype['secondary_email'] = undefined;

/**
 * @member {String} tertiary_email
 */
EditSellerDto.prototype['tertiary_email'] = undefined;

/**
 * @member {Boolean} confirmation_payment_limit
 */
EditSellerDto.prototype['confirmation_payment_limit'] = undefined;

/**
 * @member {Number} confirmation_payment_limit_days
 */
EditSellerDto.prototype['confirmation_payment_limit_days'] = undefined;

/**
 * @member {Array.<String>} responsibles
 */
EditSellerDto.prototype['responsibles'] = undefined;

/**
 * @member {String} cns
 */
EditSellerDto.prototype['cns'] = undefined;

/**
 * @member {String} cnae
 */
EditSellerDto.prototype['cnae'] = undefined;

/**
 * @member {module:model/EditSellerDto.AssignmentEnum} assignment
 */
EditSellerDto.prototype['assignment'] = undefined;

/**
 * @member {String} owner_name
 */
EditSellerDto.prototype['owner_name'] = undefined;

/**
 * @member {String} owner_document
 */
EditSellerDto.prototype['owner_document'] = undefined;

/**
 * @member {Boolean} owner_document_ofac
 */
EditSellerDto.prototype['owner_document_ofac'] = undefined;

/**
 * @member {Boolean} owner_document_onu
 */
EditSellerDto.prototype['owner_document_onu'] = undefined;

/**
 * @member {Boolean} owner_document_pep
 */
EditSellerDto.prototype['owner_document_pep'] = undefined;

/**
 * @member {Boolean} owner_document_ref
 */
EditSellerDto.prototype['owner_document_ref'] = undefined;

/**
 * @member {String} owner_birth
 */
EditSellerDto.prototype['owner_birth'] = undefined;

/**
 * @member {Boolean} frontier
 */
EditSellerDto.prototype['frontier'] = undefined;

/**
 * @member {String} erp
 */
EditSellerDto.prototype['erp'] = undefined;

/**
 * @member {Boolean} three_ds_active
 */
EditSellerDto.prototype['three_ds_active'] = undefined;

/**
 * @member {Number} min_three_ds
 */
EditSellerDto.prototype['min_three_ds'] = undefined;

/**
 * @member {Number} three_ds_value
 */
EditSellerDto.prototype['three_ds_value'] = undefined;

/**
 * @member {Boolean} risk_active
 */
EditSellerDto.prototype['risk_active'] = undefined;

/**
 * @member {Number} min_risk
 */
EditSellerDto.prototype['min_risk'] = undefined;

/**
 * @member {Number} risk_value
 */
EditSellerDto.prototype['risk_value'] = undefined;

/**
 * @member {Boolean} billet_code
 */
EditSellerDto.prototype['billet_code'] = undefined;

/**
 * @member {Boolean} card_payer_check
 */
EditSellerDto.prototype['card_payer_check'] = undefined;

/**
 * @member {Number} card_payer_check_min_value
 */
EditSellerDto.prototype['card_payer_check_min_value'] = undefined;

/**
 * @member {String} extract_name
 */
EditSellerDto.prototype['extract_name'] = undefined;

/**
 * @member {module:model/EditSellerDto.AccreditationStatusEnum} accreditation_status
 */
EditSellerDto.prototype['accreditation_status'] = undefined;

/**
 * @member {Number} celcoin_value
 */
EditSellerDto.prototype['celcoin_value'] = undefined;

/**
 * @member {module:model/EditSellerDto.CelcoinFeeTypeEnum} celcoin_fee_type
 */
EditSellerDto.prototype['celcoin_fee_type'] = undefined;
 ...
 * @readonly
 */
EditSellerDto['AccreditationStatusEnum'] = {
 ...
 * @readonly
 */
EditSellerDto['CelcoinFeeTypeEnum'] = {
