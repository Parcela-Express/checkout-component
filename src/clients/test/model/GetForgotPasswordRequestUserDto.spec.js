...
(function(root, factory) {
  ...
  describe('GetForgotPasswordRequestUserDto', function() {
    it('should create an instance of GetForgotPasswordRequestUserDto', function() {
      // uncomment below and update the code to test GetForgotPasswordRequestUserDto
      //var instane = new ParcelaExpressApi.GetForgotPasswordRequestUserDto();
      //expect(instance).to.be.a(ParcelaExpressApi.GetForgotPasswordRequestUserDto);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new ParcelaExpressApi.GetForgotPasswordRequestUserDto();
