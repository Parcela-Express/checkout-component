...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.CreateAddressDto();
  });
  ...
  describe('CreateAddressDto', function() {
    it('should create an instance of CreateAddressDto', function() {
      ...
      //var instane = new ParcelaExpressApi.CreateAddressDto();
      //expect(instance).to.be.a(ParcelaExpressApi.CreateAddressDto);
    });

    it('should have the property zipcode (base name: "zipcode")', function() {
      // uncomment below and update the code to test the property zipcode
      //var instance = new ParcelaExpressApi.CreateAddressDto();
