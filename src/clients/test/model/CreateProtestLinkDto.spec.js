...
(function(root, factory) {
  ...
  describe('CreateProtestLinkDto', function() {
    it('should create an instance of CreateProtestLinkDto', function() {
      // uncomment below and update the code to test CreateProtestLinkDto
      //var instane = new ParcelaExpressApi.CreateProtestLinkDto();
      //expect(instance).to.be.a(ParcelaExpressApi.CreateProtestLinkDto);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new ParcelaExpressApi.CreateProtestLinkDto();
