...
(function(root, factory) {
  ...
  describe('PaymentDetailsDTO', function() {
    it('should create an instance of PaymentDetailsDTO', function() {
      // uncomment below and update the code to test PaymentDetailsDTO
      //var instane = new ParcelaExpressApi.PaymentDetailsDTO();
      //expect(instance).to.be.a(ParcelaExpressApi.PaymentDetailsDTO);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new ParcelaExpressApi.PaymentDetailsDTO();
