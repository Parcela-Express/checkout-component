...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.Merchant();
  });
  ...
  describe('Merchant', function() {
    it('should create an instance of Merchant', function() {
      ...
      //var instane = new ParcelaExpressApi.Merchant();
      //expect(instance).to.be.a(ParcelaExpressApi.Merchant);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.Merchant();
    ...
    it('should have the property shipping_discount_bank_account_id (base name: "shipping_discount_bank_account_id")', function() {
      // uncomment below and update the code to test the property shipping_discount_bank_account_id
      //var instance = new ParcelaExpressApi.Merchant();
      //expect(instance).to.be();
    });

    it('should have the property shipping_discount_bank_account (base name: "shipping_discount_bank_account")', function() {
      // uncomment below and update the code to test the property shipping_discount_bank_account
      //var instance = new ParcelaExpressApi.Merchant();
      //expect(instance).to.be();
    });
    ...
    it('should have the property is_simulation_pos (base name: "is_simulation_pos")', function() {
      // uncomment below and update the code to test the property is_simulation_pos
      //var instance = new ParcelaExpressApi.Merchant();
      //expect(instance).to.be();
    });
