...
(function(root, factory) {
  ...
  describe('CancelPaymentDTO', function() {
    it('should create an instance of CancelPaymentDTO', function() {
      // uncomment below and update the code to test CancelPaymentDTO
      //var instane = new ParcelaExpressApi.CancelPaymentDTO();
    ...
    it('should have the property acquirer_reference (base name: "acquirer_reference")', function() {
      ...
      //var instance = new ParcelaExpressApi.CancelPaymentDTO();
