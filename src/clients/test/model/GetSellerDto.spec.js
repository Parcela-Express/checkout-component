  ...
  describe('(package)', function() {
    describe('GetSellerDto', function() {
      ...
      it('should create an instance of GetSellerDto', function() {
        // TODO: update the code to test GetSellerDto
      ...
      it('should have the property accountingAccountSettlementId (base name: "accounting_account_settlement_id")', function() {
        // TODO: update the code to test the property accountingAccountSettlementId
        expect(instance).to.have.property('accountingAccountSettlementId');
        // expect(instance.accountingAccountSettlementId).to.be(expectedValueLiteral);
      });

      it('should have the property totalBatch (base name: "totalBatch")', function() {
        // TODO: update the code to test the property totalBatch
        expect(instance).to.have.property('totalBatch');
        // expect(instance.totalBatch).to.be(expectedValueLiteral);
      });

      it('should have the property latestSettlement (base name: "latestSettlement")', function() {
        // TODO: update the code to test the property latestSettlement
        expect(instance).to.have.property('latestSettlement');
        // expect(instance.latestSettlement).to.be(expectedValueLiteral);
      });
