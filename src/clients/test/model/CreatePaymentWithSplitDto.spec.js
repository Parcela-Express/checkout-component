...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.CreatePaymentWithSplitDto();
  });
  ...
  describe('CreatePaymentWithSplitDto', function() {
    it('should create an instance of CreatePaymentWithSplitDto', function() {
      // uncomment below and update the code to test CreatePaymentWithSplitDto
      //var instane = new ParcelaExpressApi.CreatePaymentWithSplitDto();
      //expect(instance).to.be.a(ParcelaExpressApi.CreatePaymentWithSplitDto);
    });
    ...
    it('should have the property amount_cents (base name: "amount_cents")', function() {
      ...
      //var instance = new ParcelaExpressApi.CreatePaymentWithSplitDto();
    ...
    it('should have the property active_3ds (base name: "active_3ds")', function() {
      // uncomment below and update the code to test the property active_3ds
      //var instance = new ParcelaExpressApi.CreatePaymentWithSplitDto();
      //expect(instance).to.be();
    });

    it('should have the property risk_custom_field (base name: "risk_custom_field")', function() {
      // uncomment below and update the code to test the property risk_custom_field
      //var instance = new ParcelaExpressApi.CreatePaymentWithSplitDto();
      //expect(instance).to.be();
    });
