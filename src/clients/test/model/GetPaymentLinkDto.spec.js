...
(function(root, factory) {
  ...
  describe('GetPaymentLinkDto', function() {
    it('should create an instance of GetPaymentLinkDto', function() {
      // uncomment below and update the code to test GetPaymentLinkDto
      //var instane = new ParcelaExpressApi.GetPaymentLinkDto();
      //expect(instance).to.be.a(ParcelaExpressApi.GetPaymentLinkDto);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new ParcelaExpressApi.GetPaymentLinkDto();
