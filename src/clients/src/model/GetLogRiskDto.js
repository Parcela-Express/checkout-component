...
export class GetLogRiskDto {
   ...
   * @param accountScore {Number} 
   */
  constructor(id, sale, logs, accountScore) {
    this.id = id;
    this.sale = sale;
    this.logs = logs;
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('account_score'))
        obj.accountScore = ApiClient.convertToType(data['account_score'], 'Number');
    }
    return obj;
  }
}
 ...
 */
GetLogRiskDto.prototype.accountScore = undefined;
