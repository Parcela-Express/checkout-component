...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParcelaExpressApi.CreateSellerFileExportRequestDto();
  });
  ...
  describe('CreateSellerFileExportRequestDto', function() {
    it('should create an instance of CreateSellerFileExportRequestDto', function() {
      // uncomment below and update the code to test CreateSellerFileExportRequestDto
      //var instane = new ParcelaExpressApi.CreateSellerFileExportRequestDto();
      //expect(instance).to.be.a(ParcelaExpressApi.CreateSellerFileExportRequestDto);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new ParcelaExpressApi.CreateSellerFileExportRequestDto();
